...
const records = [
  {
    ...
    descriptionEn: "كارد President Akram Zidi took part in the Algiers fair, highlighting stronger African economic partnerships and the promotion of non-hydrocarbon exports.",
    descriptionFr: "Le président d’كارد, , a participé au salon à Alger, soulignant l’importance des partenariats économiques africains et des exportations hors hydrocarbures.",
  ...
  },
  {
    ...
    descriptionEn: "A coordination meeting involving كارد, DGRSDT, and ANVREDET defined an annual program linking university research and entrepreneurship to sustainable mining-sector innovation.",
    descriptionFr: "Une réunion de coordination réunissant كارد, la DGRSDT et l’ANVREDET a défini un programme annuel reliant recherche universitaire, entrepreneuriat et innovation minière durable.",
  ...
  },
  {
    ...
    descriptionEn: "كارد advocated local mineral-resource transformation, lower imports, and stronger non-hydrocarbon exports. A cooperation memorandum with Sonarem-Formation supports youth participation, economic-information exchange, and joint activities.",
    descriptionFr: "كارد a plaidé pour la transformation locale des ressources minières, la réduction des importations et le développement des exportations hors hydrocarbures. Un mémorandum avec Sonarem-Formation soutient les jeunes et les activités communes.",
  ...
  },
  {
    ...
    descriptionEn: "AAPI’s Director General received an كارد delegation led by Akram Zidi to discuss investment procedures, investor support, and digital allocation of economic land through the Investor Digital Platform.",
    descriptionFr: "Le Directeur général de l’AAPI a reçu une délégation d’كارد conduite par Akram Zidi pour examiner les procédures d’investissement, l’accompagnement des investisseurs et l’octroi numérique du foncier économique.",
  ...
  },
  {
    ...
    descriptionEn: "Organized by كارد with AAPI, the forum brought together ministries, institutions, and financial-sector representatives. Its recommendations addressed economic communication, specialized media, legal awareness, and consultation with economic operators.",
    descriptionFr: "Organisé par كارد avec l’AAPI, le forum a réuni ministères, institutions et acteurs financiers. Ses recommandations ont porté sur la communication économique, la presse spécialisée, la culture juridique et la concertation avec les opérateurs.",
    locationAr: "الجزائر العاصمة",
    locationEn: "Algiers",
    locationFr: "Alger",
  },
