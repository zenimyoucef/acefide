...
export const structureCopy = {
  ar: {
    ...
    pageIntro: "نظرة منظمة على قيادة المركز والمسؤوليات الأساسية داخل CARED.",
    president: "الرئاسة",
  ...
  fr: {
    ...
    pageIntro: "Vue organisée de la direction du centre et des responsabilités clés de CARED.",
