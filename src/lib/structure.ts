...
export const structureCopy = {
  ar: {
    ...
    pageEyebrow: "المركز الجزائري للتشبيك الاقتصادي و الاستثمار التنموي",
    pageTitle: "الهيكل التنظيمي للمركز",
    pageIntro: "نظرة منظمة على قيادة المركز والمسؤوليات الأساسية داخل المركز الجزائري للتشبيك الاقتصادي و الاستثمار التنموي.",
    president: "الرئاسة",
  ...
  fr: {
    ...
    pageIntro: "Vue organisée de la direction du centre et des responsabilités clés de المركز الجزائري للتشبيك الاقتصادي و الاستثمار التنموي.",
  ...
  en: {
    ...
    pageEyebrow: "المركز الجزائري للتشبيك الاقتصادي و الاستثمار التنموي",
    pageTitle: "هيكل المركز الجزائري للتشبيك الاقتصادي و الاستثمار التنموي التنظيمي",
