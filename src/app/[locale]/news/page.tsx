...
const copy = {
  ar: {
    masthead: "أخبار المركز",
    subtitle: "أخبار وتحليلات المركز الجزائري للتشبيك الاقتصادي و الاستثمار التنموي",
    ...
    <main className="min-h-screen bg-[#f5f2e9] text-[#17211d]" dir={locale === "ar" ? "rtl" : "ltr"}>
      <div className="container-content py-10 md:py-14">
        <header className="border-y-4 border-double border-[#17211d] py-5 text-center">
          <p className="text-[0.65rem] font-black uppercase tracking-[0.3em] text-primary">CARED · {text.latest}</p>
    ...
    >
      {item.coverImage ? (
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-[linear-gradient(135deg,#dfe9e1,#f4efe1)] text-primary/35">
          ...
          <span className="mt-3 text-xs font-black uppercase tracking-[0.2em]">CARED</span>
        </div>
      )}
