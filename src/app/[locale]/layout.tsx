...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    ...
    openGraph: { title: t("title"), description: t("description"), locale: "ar", siteName: "CARED", type: "website" },
