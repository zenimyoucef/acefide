...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    ...
    openGraph: { title: t("title"), description: t("description"), locale: "ar", siteName: "كارد", type: "website" },
