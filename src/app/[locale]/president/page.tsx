...
const timeline = [
  { year: "2020", en: "تأسيس كارد", ar: "تأسيس المركز الجزائري للتشبيك الاقتصادي", fr: "Fondation de كارد" },
        ...
        <div className="container-content relative z-10 py-12 md:py-16 lg:py-20">
          <div className="grid min-h-[calc(100vh-8rem)] items-center gap-10 lg:grid-cols-[0.92fr_1.08fr]">
            <article className="order-2 lg:order-1">
              <p className="text-sm font-black uppercase tracking-[0.2em] text-primary">كارد</p>
